...
class Sidebar implements IMenu
{
    public static function getMenu(): iterable
    {
        return new Collection( [
            ...
            new Title(__('users')),
            new Group(__('users'), new Collection(['users', 'histories', 'threads', 'documents', 'records']), 'user'),
            new Title('services_title', 'box'),
            new Group(__('doctors_clinics'), new Collection(['doctors', 'clinics', 'services', 'spec_reviews']), 'activity'),
